...
async function seed() {
  ...
  for (const item of data) {
    ...
    try {
      await axios.post('https://mudit-traders-fc35.vercel.app/api/products', payload);
      successCount++;
    } catch (e) {
      console.error(`Failed to add ${item.productName}:`, e.response ? e.response.data : e.message);
    }
  }
